<template>
	<div>
		...
		<div style="display: inline-block;width: 250px;margin: 10px 0 0 20px;">
			<h1>船队信息</h1>
			<el-table :data="reportList" :row-class-name="colorss" @row-click='cn'>
		...
		<div style="display: inline-block;width: 800px;margin: 10px 0 0 20px;
			...
			<div style="font-size: 14px;color: #606266;">
				...
				<el-row style='margin-top: 20px;'>
				  <el-col :span="6" >
					   <el-select  placeholder="请选择流程"  v-model='flowid' style='width: 150px;' @change='sel' >
				...
				<el-row style='margin-top: 20px;'>
				  ...
				  <el-col :span="6">
					<el-button type='primary'  :disabled="status!='未完成'" @click='startclick'>开始作业</el-button>
				  </el-col>
				  <el-col :span="6">			
